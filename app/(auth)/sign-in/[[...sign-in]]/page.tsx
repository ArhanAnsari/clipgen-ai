      ...
      <div className="flex flex-col gap-4 p-6 md:p-10">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-xs space-y-8 font-spaceGrotesk">
            ...
            <SignIn.Root>
              <SignIn.Step name="start" className="w-full space-y-8">
                {/* Logo */}
                ...
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-gray-600">Continue into ClipGen AI</p>
                </div>
              ...
              <SignIn.Step name="verifications" className="w-full space-y-8">
                {/* Header */}
                <div className="space-y-2 text-center">
                  <h1 className="text-3xl font-semibold text-gray-900">
                    Verify it&apos;s you
                ...
                <SignIn.Strategy name="email_code">
                  <div className="space-y-4">
                    <Clerk.Field name="code">
                      <Clerk.Label className="block text-sm font-medium text-gray-700 mb-3">
                        Enter code
                      </Clerk.Label>
                      ...
                      />
                      <Clerk.FieldError className="mt-2 text-sm text-rose-600 text-center" />
                    </Clerk.Field>
